...
public class TweetsListItemAdapter$$ViewInjector {
  public static void inject(Finder finder, final com.mobileappdevelopersclub.fapp.adapters.TweetsListItemAdapter target, Object source) {
    ...
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131296302' for field 'tweetHashtags' was not found. If this field binding is optional add '@Optional'.");
    }
    target.tweetHashtags = (android.widget.TextView) view;
    view = finder.findById(source, 2131296299);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131296299' for field 'tweetImage' was not found. If this field binding is optional add '@Optional'.");
    }
    target.tweetImage = (android.widget.ImageView) view;
    view = finder.findById(source, 2131296301);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131296301' for field 'tweetText' was not found. If this field binding is optional add '@Optional'.");
    }
    target.tweetText = (android.widget.TextView) view;
    view = finder.findById(source, 2131296300);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131296300' for field 'tweetUsername' was not found. If this field binding is optional add '@Optional'.");
    }
